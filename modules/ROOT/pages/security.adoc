...
Yes, you can setup a bubble geofence to have a small relative fence around drones, moving along the show trajectory together with the drones.
If there is too much individual drift, the bubble geofence will kick in.
For a more detailed description about setting up geofences, see the https://doc.collmot.com/public/skybrush-firmware-doc/latest/configuration/geofence.html[Skybrush firmare documentation].
