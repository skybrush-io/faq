...
Ardupilot also stores it's log files on the SD card.
Its best to have 2MB of flash memory to accommodate the Skybrush firmware and its requirement to address your LEDs.
...
Most users run mavesp8266 firmware on their WiFi modules.
...
*NOTE:* SiK radios aren't really designed for broadcasting;
