...
. An optional <<what-kinds-of-pyro-devices-does-skybrush-firmware-support,pyro device>>
...
The most up-to-date list of supported light fixtures can be found in the https://doc.collmot.com/public/skybrush-firmware-doc/latest/configuration/led.html[LED configuration] section of the *Skybrush firmware* documentation.

[#what-kinds-of-pyro-devices-does-skybrush-firmware-support]
== What kinds of pyro devices does Skybrush firmware support?

Skybrush supports optional pyro triggering on multiple pyro channels.
The supported list of pyro devices can be found in the https://doc.collmot.com/public/skybrush-firmware-doc/latest/configuration/pyro.html[Pyro configuration] section of the *Skybrush firmware* documentation.
